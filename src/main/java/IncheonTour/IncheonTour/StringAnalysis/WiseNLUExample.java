package IncheonTour.IncheonTour.StringAnalysis;
...
public class WiseNLUExample {
    ...
    public static String Analysis() {
        ...
        String accessKey = "968833f7-2c4e-400f-9585-789627899965";   // 발급받은 API Key
        String analysisCode = "morp";        // 언어 분석 코드
        String text = "";           // 분석할 텍스트 데이터
        Gson gson = new Gson();

        // 언어 분석 기술(구어)
        text += "인천 미추홀구 오늘 열리는 행사 알려줘";
        ...
        try {
            ...
            morphemes
                    ...
                    .forEach(morpheme -> {
                        ...
                        //stringBuffer.append("[명사] " + morpheme.text + "\n");
                    });
        } catch (IOException e) {
            e.printStackTrace();
        }
